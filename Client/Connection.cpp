...
http::response<http::string_body> Connection::UploadFile(const std::string& filename, const std::string& target, const std::string& contentType, const std::string& digestResponse, std::string id)
{
    try
    {        
